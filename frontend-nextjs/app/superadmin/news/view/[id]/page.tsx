...
export default function SuperAdminNewsViewPage() {
          ...
          <div className="text-center py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              ...
              <Button variant="outline" asChild>
                <Link href="/superadmin/news">Back to News</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Link href="/superadmin/news" className="flex items-center gap-1 hover:text-primary transition-colors">
            ...
            <Button
              ...
              asChild
            >
              <Link href={`/superadmin/news/edit/${article.id}`}>
                    ...
                    <div className="space-y-3">
                      {relatedArticles.map((relatedArticle) => (
                        <Link
                          ...
                          href={`/superadmin/news/view/${relatedArticle.id}`}
