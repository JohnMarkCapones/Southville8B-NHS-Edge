        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              <AnimatedCard animation="float" className="bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-900 dark:to-blue-900/20">
                <CardHeader>
              ...
              <AnimatedCard animation="float" className="bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-900 dark:to-purple-900/20">
                <CardHeader>
