...
import { announcementsData as fallbackAnnouncements } from "@/lib/announcements-data"
...
type Announcement = (typeof fallbackAnnouncements)[number]
...
export default function AnnouncementsClient({ initialItems }: { initialItems?: Announcement[] }) {
  ...
  const items: Announcement[] = initialItems && initialItems.length ? initialItems : fallbackAnnouncements
      ...
      <section className="py-12 border-y border-border/50 bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                { label: "Total Announcements", value: items.length, icon: Bell },
                { label: "Urgent", value: items.filter((a) => a.category === "urgent").length, icon: AlertCircle },
                { label: "Academic", value: items.filter((a) => a.category === "academic").length, icon: BookOpen },
                { label: "Events", value: items.filter((a) => a.category === "event").length, icon: Trophy },
              ].map((stat, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              {(Object.entries(categoryConfig) as Array<[CategoryKey, (typeof categoryConfig)[CategoryKey]]>).map(
                ([key, config]) => {
